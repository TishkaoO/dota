...
public class CharacterDaoImpl implements CharacterDao {
    ...
    {
        aspectCharacterList.add(new Character(1, "Phantom Assassin", "Methodical"));
        aspectCharacterList.add(new Character(2, "Phantom Assassin", "Sweet Release"));
        aspectCharacterList.add(new Character(3, "Juggernaut", "Bladestorm"));
        aspectCharacterList.add(new Character(4, "Juggernaut", "Bladeform"));
        aspectCharacterList.add(new Character(5, "Zeus", "Livewire"));
        aspectCharacterList.add(new Character(6, "Zeus", "Divine Rampage"));
        aspectCharacterList.add(new Character(7, "Invoker", "Scholar of Koryx"));
        aspectCharacterList.add(new Character(8, "Invoker", "Mind of Tornarus"));
        aspectCharacterList.add(new Character(9, "Invoker", "Agent of Gallaron"));
        aspectCharacterList.add(new Character(10, "Axe", "One Man Army"));
        aspectCharacterList.add(new Character(11, "Axe", "Call Out"));
        aspectCharacterList.add(new Character(12, "Legion Commander", "Stonehall Plate"));
        aspectCharacterList.add(new Character(13, "Legion Commander", "Spoils of War"));
        aspectCharacterList.add(new Character(14, "Jakiro", "Twin Terror"));
        aspectCharacterList.add(new Character(15, "Jakiro", "Ice Breaker"));
        aspectCharacterList.add(new Character(16, "Ancient Apparition", "Bone Chill"));
        aspectCharacterList.add(new Character(17, "Ancient Apparition", "Exposure"));
        aspectCharacterList.add(new Character(18, "Crystal Maiden", "Glacial Guard"));
        aspectCharacterList.add(new Character(19, "Crystal Maiden", "Arcane Overflow"));
        aspectCharacterList.add(new Character(20, "Witch Doctor", "Headhunter"));
        aspectCharacterList.add(new Character(21, "Witch Doctor", "Cleft Death"));
    }
    ...
    @Override
    public Character findCharacterAspectSwap(int idCharacter) { //как проверить?
        if (seveCharcterList == null && seveCharcterList.isEmpty()) {
            System.out.println("Драфт пустой");
            return null;
        }
        if (aspectCharacterList == null && aspectCharacterList.isEmpty()) {
            System.out.println("Список аспектов пуст");
            return null;
        }
        ...
        String nemeCharacter = targetCharacter.getName();
        String nameAspect = targetCharacter.getAspect();
        for (Character aspectCharacter : aspectCharacterList) {
            if (aspectCharacter != null && nemeCharacter.equals(aspectCharacter.getName()) && !aspectCharacter.equals(nameAspect)) {
                targetCharacter.setAspect(aspectCharacter.getAspect());
